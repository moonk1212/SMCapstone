            ...
            <div style="float:right">
              ...
              <tr>
				...
				<td><input type="text" name="my_btm_thigh" id="my_btm_thigh" class="form-control tooltipstered" maxlength="4"
								required="required" aria-required="true" size="1" value="${mybottom.my_btm_thigh}" readonly></td>
				 <td><input type="text" name="my_btm_hem" id="my_btm_hem"class="form-control tooltipstered" maxlength="4"
								required="required" aria-required="true" size="1" value="${mybottom.my_btm_hem}" readonly></td>
          ...
          <div id="size2">
            ...
            <div style="float:right">
              ...
              <tr>
                ...
                <td><input type="text" name="thigh1" id="thigh1" size="1" class="form-control tooltipstered" maxlength="4"></td>
                <td><input type="text" name="hem1" id="hem1" size="1" class="form-control tooltipstered" maxlength="4"></td>
              </tr>
              <tr>
                <td>M</td>
                ...
                <td><input type="text" name="thigh2" id="thigh2" size="1" class="form-control tooltipstered" maxlength="4"></td>
                <td><input type="text" name="hem2" id="hem2" size="1" class="form-control tooltipstered" maxlength="4"></td>
              </tr>
