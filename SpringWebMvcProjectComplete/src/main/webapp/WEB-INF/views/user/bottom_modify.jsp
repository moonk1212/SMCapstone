...
<c:if test="${not empty login}">
  ...
  <div class="container">
    ...
    <div class="box">
      ...
      <a href="<c:url value='/user/bottom_modify'/>"><button class="btn2"> <img src="${ctx}/resources/ic/bottom/btn_modify_s.png" alt="sizemodify" ></button></a>
	...
	<div class="box">
        ...
        <div class="div-table1">
          ...
          <div align="center" style="padding-top:120px;">
            <input type ="image" src="${ctx }/resources/ic/bottom/btn_size_modify.png" alt="oneline"
             class= "btn" id="update-btn">
          </div>
        </div>
      </div>
</div>
...
<script src="<c:url value='/dist/js/custom/user-bottom-modify-validation.js'/>"></script>
</c:if>
